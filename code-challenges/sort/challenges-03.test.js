...
const sortMeetingsByDay = (arr) => arr.sort((a, b) => getDayOrder(a.dayOfWeek) - getDayOrder(b.dayOfWeek));
...
const sortSchedule = (arr) => arr.sort((a, b) => compare(a, b,
  (a, b) => getDayOrder(a.dayOfWeek) - getDayOrder(b.dayOfWeek),
  (a, b) => a.start - b.start,
