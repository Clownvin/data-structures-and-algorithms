...
const { Graph, createdOrderedGraphConstructor } = require('../graph');
const OrderedGraph = createdOrderedGraphConstructor((a, b) => a.localeCompare(b));


const {emojify} = require('../../randomojis/randomojis');

describe('Unorded Graph (simply Graph)', () => {
  let graph = new Graph();
...
describe('OrderedGraph', () => {
  let graph = new OrderedGraph();
